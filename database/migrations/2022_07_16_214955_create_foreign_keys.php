...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('client_governorate', function(Blueprint $table) {
			$table->foreign('government_id')->references('id')->on('governorates')
						->onDelete('no action')
						->onUpdate('no action');
		});
		Schema::table('client_post', function(Blueprint $table) {
			$table->foreign('client_id')->references('id')->on('client_post')
						->onDelete('no action')
						->onUpdate('no action');
		});
		Schema::table('client_post', function(Blueprint $table) {
			$table->foreign('post_id')->references('id')->on('client_post')
						->onDelete('no action')
						->onUpdate('no action');
		});
		Schema::table('client_notification', function(Blueprint $table) {
			$table->foreign('client_id')->references('id')->on('client_notification')
						->onDelete('no action')
						->onUpdate('no action');
		});
		Schema::table('client_notification', function(Blueprint $table) {
			$table->foreign('notification_id')->references('id')->on('client_notification')
						->onDelete('no action')
						->onUpdate('no action');
		});
		...
		Schema::table('blood_type_client', function(Blueprint $table) {
			$table->foreign('blood_type_id')->references('id')->on('blood_type_client')
						->onDelete('no action')
						->onUpdate('no action');
		});
		Schema::table('blood_type_client', function(Blueprint $table) {
			$table->foreign('client_id')->references('id')->on('blood_type_client')
						->onDelete('no action')
						->onUpdate('no action');
		});
	}
	...
	public function down()
	{
		...
		Schema::table('client_governorate', function(Blueprint $table) {
			$table->dropForeign('client_governorate_government_id_foreign');
		});
		Schema::table('client_post', function(Blueprint $table) {
